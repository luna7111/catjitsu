...
@onready var player_slot_reference = $"../Player/PlayerCardSlot"
...
func _ready() -> void:
	...
	$"../Player/InputManager".connect("left_mouse_button_released", on_left_click_released)
...
func finish_drag():
	if card_being_dragged:
		...
		if card_slot_found and not card_slot_found.card_in_slot:
			...
			player_hand_reference.add_card_to_hand(card_being_dragged, DEFAULT_MOVE_CARD_SPEED)
