...
from .views import PlayerList, PlayerDetail, MatchList, MatchDetail, OAuth42Login, OAuth42Callback, IdentifyClient, auth_completed, TestGame

urlpatterns = [
    path("testgame/", TestGame.as_view(), name="test_game"),
